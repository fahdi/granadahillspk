...
var _whatInput = __webpack_require__(13);
...
(0, _jquery2.default)(function () {
  (0, _jquery2.default)(window).scroll(function () {
    ...
    if (winTop >= 30) {
      (0, _jquery2.default)("body").addClass("sticky-shrinknav-wrapper");
    } else {
      (0, _jquery2.default)("body").removeClass("sticky-shrinknav-wrapper");
    }
  });
});
...
function parallax() {
  ...
  (0, _jquery2.default)('#mobley-header').css('background-position', 'center ' + -(scrolled * 0.35) + 'px');
}
